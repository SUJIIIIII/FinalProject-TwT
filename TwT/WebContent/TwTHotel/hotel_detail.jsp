...
<body id="body">
	...
	<script type="text/javascript">
	    $(document).ready(function() {
	      ...
	      $(".hero-wrap").attr('style',"background-image: url('<%=request.getContextPath()%>/images/bg_12.jpg');");
	      $(".bread").text('Hotel');
	   	});
   	</script>
          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(<%=request.getContextPath()%>/images/hotel-2.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(<%=request.getContextPath()%>/images/hotel-3.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(<%=request.getContextPath()%>/images/hotel-4.jpg);"></div>
          				</div>
          			</div>
          		</div>
          		<!-- 호텔 사진 끝 -->
          			...
          			<div class="row">
          				...
          				<div class="col-md-4">
				    				<div class="destination">
				    					<a href="<%=request.getContextPath()%>/hotel-single.html" class="img img-2" style="background-image: url(<%=request.getContextPath()%>/images/room-4.jpg);"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="<%=request.getContextPath()%>/hotel-single.html">스위트 룸</a></h3>
						    						<p class="rate">
				    			...
				    			<div class="col-md-4">
				    				<div class="destination">
				    					<a href="<%=request.getContextPath()%>/hotel-single.html" class="img img-2" style="background-image: url(<%=request.getContextPath()%>/images/room-5.jpg);"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
				    			...
				    			<div class="col-md-4">
				    				<div class="destination">
				    					<a href="<%=request.getContextPath()%>/hotel-single.html" class="img img-2" style="background-image: url(<%=request.getContextPath()%>/images/room-6.jpg);"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
