...
<head>
	...
	<link rel="stylesheet" href="<%=request.getContextPath()%>/TwTCommunity/css/community_detail_css.css">
          ...
          <div class="col-md-4 sidebar ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(<%=request.getContextPath()%>/images/image_1.jpg);"></a>
                <div class="text">
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(<%=request.getContextPath()%>/images/image_2.jpg);"></a>
                <div class="text">
                  <h3 class="heading"><a href="#">Even the all-powerful Pointing</a></h3>
                  <div class="meta">
                    <div><a href="#"><i class="fa fa-calendar"></i> 날짜</a></div>
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(<%=request.getContextPath()%>/images/image_3.jpg);"></a>
                <div class="text">
                  <h3 class="heading"><a href="#">Even the all-powerful Pointing</a></h3>
                  <div class="meta">
                    <div><a href="#"><i class="fa fa-calendar"></i> 날짜</a></div>
