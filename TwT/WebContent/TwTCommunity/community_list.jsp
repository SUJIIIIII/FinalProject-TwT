...
<body id="body">
	...
	<script type="text/javascript">
	    $(document).ready(function() {
	      ...
	      $(".hero-wrap").attr('style',"background-image: url('<%=request.getContextPath()%>/images/bg_7.jpg');");
						...
						<div class="row d-flex">
				          <div class="col-md-3 d-flex ftco-animate">
				            <div class="blog-entry align-self-stretch" style="min-width: 250px;">
				              <a href="<%=request.getContextPath()%>/TwTCommunity/community_detail.jsp" class="block-20" style="background-image: url('<%=request.getContextPath()%>/images/image_1.jpg');"></a>
				              <div class="text p-4 d-block" style="min-width: 250px;">
					            ...
					            <br>
			              	    <h3 class="heading"><a href="<%=request.getContextPath()%>/TwTCommunity/community_detail.jsp">태국 여행</a></h3>
			                    <div class="tagcloud">
				          ...
				          <div class="col-md-3 d-flex ftco-animate">
				            <div class="blog-entry align-self-stretch" style="min-width: 250px;">
				              <a href="blog-single.html" class="block-20" style="background-image: url('<%=request.getContextPath()%>/images/image_1.jpg');"></a>
				              <div class="text p-4 d-block" style="min-width: 250px">
				              	<span class="tag">2020.02.05</span>
				              	<span class="tag">| 5DAYS</span>
				              	<span style="padding: 0 0 0 18px;">
				              	...
				              	<br>
			              	    <h3 class="heading"><a href="#">태국 여행</a></h3>
			                    <div class="tagcloud">
				                <a href="#" class="tag-cloud-link">나홀로</a>
				                <a href="#" class="tag-cloud-link">비즈니스 여행</a>
			               	 	</div>
				          ...
				          <div class="col-md-3 d-flex ftco-animate">
				            <div class="blog-entry align-self-stretch" style="min-width: 250px">
				              ...
				              <div class="text p-4 d-block" style="min-width: 250px">
			              	    ...
			              	    <h3 class="heading"><a href="#">태국 여행</a>
			              	    </h3>
			                    <div class="tagcloud">
				                <a href="#" class="tag-cloud-link">나홀로</a>
				                <a href="#" class="tag-cloud-link">비즈니스 여행</a>
				    ...
				    <!-- fade 2 -->
		              <div class="tab-pane fade" id="v-pills-mission" role="tabpanel" aria-labelledby="v-pills-mission-tab">
				        <div style="float: top; margin-left:985px;">
				        	<a href="<%=request.getContextPath()%>/TwTCommunity/community_insert.jsp" class="btn btn-primary btn-outline-primary mt-4 px-4 py-3 mb-4"><span>Create Book</span></a>
				        </div>
				        <div class="container">
				          	...
				          	<div class="row ftco-animate">
						          <div class="col-md-12">
						            <div class="carousel-testimony owl-carousel">
						              <div class="item">
										<img src="<%=request.getContextPath()%>/images/image_1.jpg"/>
						              </div>
						              <div class="item">
										<img src="<%=request.getContextPath()%>/images/image_1.jpg"/>
						              </div>
