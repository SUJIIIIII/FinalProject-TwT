...
<link rel="stylesheet" href="<%=request.getContextPath()%>/TwTAccount/css/form.css">
...
<style type="text/css">
body {
	background-image: url("images/mypage_bg.jpg");
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
		            ...
		            <li class="nav-item"><a href="<%=request.getContextPath()%>/TwTCommunity/community_list.jsp" class="nav-link">Community</a></li>
          			<li class="nav-item"><a href="<%=request.getContextPath()%>/TwTAccount/mypage.jsp" class="nav-link" style="color:#fc3c3c;"><i class="fas fa-user"></i>&nbsp;My</a></li>
			...
			<div class="col-sm-6">
				<a href="#" data-toggle="modal" data-target="#exampleModalCenter">
					<figure class="snip1432">
						<img src="images/route1.jpg" width="150">
						<figcaption>
							<div>
								<h3>Thailand</h3>
								<h3>작성한 일정 (3개)</h3>
			...
			<div class="row row-cols-1 row-cols-md-3">
				<div class="col mb-4">
					<div class="card h-100">
						<img src="images/image_1.jpg" class="card-img-top" alt="...">
						<div class="card-body">
				...
				<div class="modal-body">
					<div class="my_route" id="myroute">
						<div style="float: left; margin-top: -3px; display: inline;">
							<img src="images/Ticket-icon.png" width="65">
						</div>
