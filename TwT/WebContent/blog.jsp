...
<html lang="en">
  ...
  <!-- <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="index.jsp">TwT</a>
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a href="/Plan/plan_create.jsp" class="nav-link">Plan</a></li>
          <li class="nav-item"><a href="zairline_main.jsp" class="nav-link">Flight</a></li>
          <li class="nav-item"><a href="hotel.jsp" class="nav-link">Hotels</a></li>
          <li class="nav-item"><a href="javascript:addName(community);" class="nav-link">Community</a></li>
          <li class="nav-item active"><a href="blog.jsp" class="nav-link">Community</a></li>
          <li class="nav-item cta"><a href="#" class="nav-link"><span>Login</span></a></li>
        </ul>
      </div>
    </div>
  </nav>
	...
	<script type="text/javascript">
	    $(document).ready(function() {
	      ...
	      $(".hero-wrap").attr('style',"background-image: url('images/bg_7.jpg');");
          ...
          <div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              ...
              <div class="text p-4 d-block">
                ...
                <h3 class="heading mt-3"><a href="#">제목</a></h3>
                <div class="meta mb-3">
