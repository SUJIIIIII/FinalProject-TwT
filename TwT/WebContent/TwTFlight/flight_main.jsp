...
<body id="body">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active"><a href="<%=request.getContextPath()%>/TwTFlight/flight_main.jsp" class="nav-link">Flight</a></li>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('<%=request.getContextPath() %>/images/bg_9.jpg');">
		            ...
		            <div class="carousel-testimony owl-carousel">
		              <div class="item">
		                <div class="item">
		                  ...
		                  <div class="user-img mb-5" style="background-image: url(images/destination-1.jpg)">
		                  </div>
		              ...
		              <div class="item">
		                <div class="item">
		                <div class="testimony-wrap d-flex">		                	
		                  <div class="user-img mb-5" style="background-image: url(images/destination-2.jpg)">
		                  </div>
		              ...
		              <div class="item">
		                <div class="testimony-wrap d-flex">		                	
		                  <div class="user-img mb-5" style="background-image: url(images/destination-3.jpg)">
		                  </div>
