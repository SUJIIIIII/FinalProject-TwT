    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a href="<%=request.getContextPath()%>/TwTFlight/flight_main.jsp" class="nav-link">Flight</a></li>
          <li class="nav-item"><a href="<%=request.getContextPath()%>/TwTHotel/hotel_list.jsp" class="nav-link">Hotels</a></li>
          <li class="nav-item"><a href="<%=request.getContextPath()%>/TwTCommunity/community_list.jsp" class="nav-link">Community</a></li>
          <li class="nav-item"><a href="<%=request.getContextPath()%>/TwTAccount/mypage.jsp" class="nav-link"><i class="fas fa-user"></i>&nbsp;My</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <div class="enjoy-css" style="font-family: 'Kalam', cursive;" onclick="location.href='<%=request.getContextPath()%>/TwTPlan/plan_create.jsp'">Create Plan!</div>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row d-flex">
          <div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="<%=request.getContextPath()%>/TwTCommunity/community_detail.jsp" class="block-20" style="background-image: url('images/image_1.jpg');">
              </a>
