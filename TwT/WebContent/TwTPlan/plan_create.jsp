...
<!-- 	<meta name="description" content="20만개의 여행일정, 나만의 여행일정 계획하기">
	...
	<link rel="stylesheet" href="<%=request.getContextPath()%>/TwTPlan/css/default_ko.css">
	...
	<div id="header">
		<div class="wrap" style="width:100%;padding:0px 10px;">
			...
			<div class="fr gnb_box">
				...
				<a href="../index.jsp"><div class="fr gnb_plan_create_close_btn" style="background: #ffba00;border: solid 1px #ffba00;">닫기</div></a>
				<div class="clear"></div>
			</div>
