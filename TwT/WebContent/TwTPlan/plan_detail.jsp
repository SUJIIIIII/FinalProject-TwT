...
<head>
	...
	<link rel="stylesheet" href="<%=request.getContextPath()%>/TwTPlan/css/default_ko.css" type="text/css">
	<link rel="stylesheet" href="<%=request.getContextPath()%>/TwTPlan/css/reset.css">
	<link rel="stylesheet" href="<%=request.getContextPath()%>/TwTPlan/css/default.css">
	<link rel="stylesheet" href="<%=request.getContextPath()%>/TwTPlan/css/gnb.css">
...
<!-- <script>
			...
			<div class="fl" style="width:181px;height:62px;line-height:62px;border-right:solid #ebebeb 1px;text-align:center;color: #555555;font-size:16px;font-weight:bold;" id="plan_total_budget">KRW 0</div>
				...
				<div class="fr gnb_box">
					<div class="fr" style="margin-top:9px;margin-right:20px;">
						...
						<a href="/ko/mypage/et_0630673001418979048?type=plan">
	...
	<link rel="stylesheet" href="<%=request.getContextPath()%>/TwTPlan/css/tipsy.css" type="text/css">
	<link rel="stylesheet" href="<%=request.getContextPath()%>/TwTPlan/css/workspace.css">
	<link rel="stylesheet" href="<%=request.getContextPath()%>/TwTPlan/css/date_picker.css">
	...
	<script type="text/javascript" src="/res/js/infobubble.js"></script>
	...
	<div id="full_wrap" style="width: 100%; height: 648px;">
		<div class="fl left_full_box">
			<div class="fl">
				...
				<ul id="pn_date_controll_box" data="" data-member_srl="1213145">
					<li data="con_date">		
		    ...
		    <div class="fl" id="schedule_full_box" style="width:265px" data="0">
	        	<div class="title_box" style="background: #393E46;">
	          		<div id="schedule_detail_title" data-date="01-31" style="display: block;">
                  		<div class="fl schedule_detail_title_text" style="width:245px;padding-left:10px;font-size:15px;">
                  			...
                  			<div class="fr day_next_btn" style="background:url('<%=request.getContextPath()%>/TwTPlan/images/_next_icon.png') no-repeat 6px 6px;" onclick="plan_day_next()"></div>
                  			<div class="fr day_prev_btn" style="background:url('<%=request.getContextPath()%>/TwTPlan/images/_prev_icon.png') no-repeat 6px 6px;" onclick="plan_day_prev()"></div>
                  			<div class="clear"></div>
                  		</div>
		                <div class="clear"></div>
		          	</div>
		        ...
		        <!--//(s)스케쥴 디테일 리스트-->
		        <!-- @@@수정 호버 시 아이콘 나오게@@@ -->
		        <div id="schedule_detail_box" class="connectedSortable ui-sortable" style="height: 556px; display: block;">
		        	<div class="day_spot_item" data="1" data-set_day="1" data-rel_srl="4740" data-pl_type="0" data-no="0" data-pl_cat="301" data-latlng="18.80455200,98.92134900" data-ci="87">
		        		<div class="item_ctrl_box">
		        			<div class="fl item_copy_plan" title="장소복사"><img src="<%=request.getContextPath()%>/TwTPlan/images/item_more_icon_a.png"></div>
		        			<div class="fl item_set_plan" title="메모&amp;예산"><img src="<%=request.getContextPath()%>/TwTPlan/images/item_set_icon_a.png"></div>
		        			<div class="fl btn_del" title="삭제"><img src="<%=request.getContextPath()%>/TwTPlan/images/item_del_icon_a.png"></div>
		        			<div class="clear"></div>
		        		</div>
		        		<div class="img_box fl">
		        			...
		        			<div style="position:absolute;top:35px;left:40px;width:22px;height:20px;">
		        				<img src="<%=request.getContextPath()%>/TwTPlan/images/list_memo_btn_off.png" class="memo_indi" style="width:22px;height:20px;">
		...
		<div id="right_full_box" class="fl" style="position: absolute; left: 425px; top: 66px; width: 1111px;">
			<div id="on_city_open_btn" style="background:url('<%=request.getContextPath()%>/TwTPlan/images/city_open_btn.png');"></div>
           	<div id="city_list" data="87" style="display: block;">
                ...
                <div id="on_city_close_btn" style="background:url('<%=request.getContextPath()%>/TwTPlan/images/city_close_btn.png');"></div>
                <div class="clear"></div>
                ...
                <div class="list_search_full_box">
                    ...
                    <div class="list_category_box">
                    	<div class="list_cat_item fl on" data="3"><img src="<%=request.getContextPath()%>/TwTPlan/images/ic_300_c.png"></div>
                        <div class="list_cat_item fl" data="2"><img src="<%=request.getContextPath()%>/TwTPlan/images/ic_200_a.png"></div>
                        <div class="list_cat_item fl" data="4"><img src="<%=request.getContextPath()%>/TwTPlan/images/ic_400_a.png"></div>
						<div class="list_cat_item fl" data="1"><img src="<%=request.getContextPath()%>/TwTPlan/images/ic_100_a.png"></div>
						<div class="list_cat_item fl" data="5"><img src="<%=request.getContextPath()%>/TwTPlan/images/ic_000_a.png"></div>
                        <div class="clear"></div>
                ...
                <div class="list_box connectedSortable" style="height: 406px;">
                	<div class="day_spot_item ui-draggable" data="0" data-set_day="0" data-rel_srl="4740" data-pl_type="0" data-no="0" data-pl_cat="301" data-ci="87">
                		...
                		<div class="spot_to_inspot"><img src="<%=request.getContextPath()%>/TwTPlan/images/spot_to_inspot_a.png"></div>
                		<div class="clear"></div>
                	</div>
				...
				<div class="day_spot_item ui-draggable" data="0" data-set_day="0" data-rel_srl="18342" data-pl_type="0" data-no="31" data-pl_cat="301" data-ci="87">
					...
					<div class="fl info_box">
						...
						<div class="sub include_pn_day" style="color:#1a7ad9"></div>
					</div><div class="spot_to_inspot"><img src="<%=request.getContextPath()%>/TwTPlan/images/spot_to_inspot_a.png"></div>
					<div class="clear"></div>
				</div>
			...
			<div id="map" class="fr" style="height: 648px; position: relative; width: 746px; overflow: hidden;">
