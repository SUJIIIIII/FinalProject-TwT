...
ORDER BY TS_DATE DESC
		...
		SELECT TS.TS_CODE, TS.M_CODE, TS.TS_TITLE, TS.TS_SDAY, TS.TS_THEME, TS.TS_PEOPLE, TS.TS_PERIOD, TS.TS_DATE, TS.TS_VIEW, M.M_NAME, FL.FL_CODE, FL.M_CODE, FL.FL_CHECK
		FROM TRAVELSCHEDULE TS 
		LEFT JOIN TWTMEMBER M ON (TS.M_CODE = M.M_CODE) 
		...
		SELECT *
		FROM FAVORITE_LIST
		WHERE FL_CODE = 'TS1' AND M_CODE = 'M1'
				SELECT TS.TS_CODE, TS.M_CODE, TS.TP_CODE, TS.TS_TITLE, TS.TS_SDAY, TS.TS_THEME, TS.TS_PEOPLE, TS.TS_THUM, TS.TS_PERIOD, TS.TS_DATE, TS.TS_VIEW, M.M_NAME, TP.CITY_CODE, TP.TP_IMG, FL.FL_CODE, FL.M_CODE, FL.FL_CHECK 
				FROM TRAVELSCHEDULE TS 
				LEFT JOIN TWTMEMBER M ON (TS.M_CODE = M.M_CODE) 
				LEFT JOIN TRAVELPOINT TP ON(TS.TP_CODE = TP.TP_CODE)
				LEFT JOIN FAVORITE_LIST FL ON(TS.TS_CODE = FL.FL_CODE)
