						...
						<div class="row d-flex">
				          <div class="col-md-3 d-flex ftco-animate">
				            <div class="blog-entry align-self-stretch" style="min-width: 250px;">
				              <a href="communityDetail" class="block-20" style="background-image: url('${pageContext.request.contextPath}/resources/images/image_1.jpg');"></a>
				              <div class="text p-4 d-block" style="min-width: 250px;">
					            ...
					            <br>
			              	    <h3 class="heading"><a href="communityDetail">태국 여행</a></h3>
			                    <div class="tagcloud">
				          ...
				          <div class="col-md-3 d-flex ftco-animate">
				            <div class="blog-entry align-self-stretch" style="min-width: 250px">
				              ...
				              <div class="text p-4 d-block" style="min-width: 250px">
			              	    ...
			              	    <h3 class="heading"><a href="communityDetail">태국 여행</a>
			              	    </h3>
			                    <div class="tagcloud">
				                <a href="#" class="tag-cloud-link">나홀로</a>
				                <a href="#" class="tag-cloud-link">비즈니스 여행</a>
				    ...
				    <!-- fade 2 -->
		              <div class="tab-pane fade" id="v-pills-mission" role="tabpanel" aria-labelledby="v-pills-mission-tab">
				        <div style="float: top; margin-left:985px;">
				        	<a href="communityInsert" class="btn btn-primary btn-outline-primary mt-4 px-4 py-3 mb-4"><span>Create Book</span></a>
				        </div>
				        <div class="container">
