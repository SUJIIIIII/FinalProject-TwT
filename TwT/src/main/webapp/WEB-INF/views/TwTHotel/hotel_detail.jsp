          			...
          			<div class="row">
          				...
          				<div class="col-md-4">
				    				<div class="destination">
				    					<a href="<%=request.getContextPath()%>/hotel-single.html" class="img img-2" style="background-image: url(${pageContext.request.contextPath}/resources/images/room-4.jpg);"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
