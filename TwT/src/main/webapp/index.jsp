    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <%-- <li class="nav-item"><a href="${pageContext.request.contextPath}/WEB-INF/views/TwTPlan/plan_create.jsp" class="nav-link">Plan</a></li>
          <li class="nav-item"><a href="${pageContext.request.contextPath}/WEB-INF/views/TwTFlight/flight_main.jsp" class="nav-link">Flight</a></li>
          <li class="nav-item"><a href="${pageContext.request.contextPath}/WEB-INF/views/TwTHotel/hotel_list.jsp" class="nav-link">Hotels</a></li>
          <li class="nav-item"><a href="${pageContext.request.contextPath}/WEB-INF/views/TwTCommunity/community_list.jsp" class="nav-link">Community</a></li>
          <li class="nav-item"><a href="${pageContext.request.contextPath}/WEB-INF/views/TwTAccount/mypage.jsp" class="nav-link"><i class="fas fa-user"></i>&nbsp;My</a></li>
          <li class="nav-item cta"><a href="${pageContext.request.contextPath}/src/main/webapp/WEB-INF/views/TwTAccount/login.jsp" class="nav-link"><span>Login</span></a></li> --%>
        </ul>
      </div>
    </div>
  </nav>
        ...
        <div class="row d-flex">
          <div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="communityDetail" class="block-20" style="background-image: url('${pageContext.request.contextPath}/resources/images/image_1.jpg');">
              </a>
          ...
          <div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="communityDetail" class="block-20" style="background-image: url('${pageContext.request.contextPath}/resources/images/image_2.jpg');">
              </a>
              <div class="text p-4">
          ...
          <div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="communityDetail" class="block-20" style="background-image: url('${pageContext.request.contextPath}/resources/images/image_3.jpg');">
              </a>
              <div class="text p-4">
          ...
          <div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="communityDetail" class="block-20" style="background-image: url('${pageContext.request.contextPath}/resources/images/image_4.jpg');">
              </a>
              <div class="text p-4">
              	<span class="tag">Tips, Travel</span>
                <h3 class="heading mt-3"><a href="#" style="text-overflow: ellipsis;">Even the all-powerful Pointing has no control about the blind texts</a></h3>
          ...
          <div class="col-md-7 heading-section ftco-animate">
    		...
    		<div class="row">
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="destination">
    					<a href="hotelDetail" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(${pageContext.request.contextPath}/resources/images/restaurant-1.jpg);">
    						<div class="icon d-flex justify-content-center align-items-center">
    							<span class="icon-search2"></span>
    						</div>
    					</a>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="destination">
    					<a href="hotelDetail" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(${pageContext.request.contextPath}/resources/images/restaurant-2.jpg);">
    						<div class="icon d-flex justify-content-center align-items-center">
    							<span class="icon-search2"></span>
    						</div>
    					</a>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="destination">
    					<a href="hotelDetail" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(${pageContext.request.contextPath}/resources/images/restaurant-3.jpg);">
    						<div class="icon d-flex justify-content-center align-items-center">
    							<span class="icon-search2"></span>
    						</div>
    					</a>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="destination">
    					<a href="hotelDetail" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(${pageContext.request.contextPath}/resources/images/restaurant-4.jpg);">
    						<div class="icon d-flex justify-content-center align-items-center">
    							<span class="icon-search2"></span>
    						</div>
    					</a>
